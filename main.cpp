...
int main(){
    ...
    cout << "\t\t\t<============================================= MY NAME IS JARVIS ==========================================>" << endl << endl;
    string phrase = "Welcome. I'm a virtual assistant. My name is Jarvis.";
    string command = "espeak \"" + phrase + "\"";
    const char *charCommand = command.c_str();
    system(charCommand);
    ...
    do{
        cout << "=======================" << endl;
        cout << "| Boss! is this you? |" << endl;
        cout << "=======================" << endl << endl;
        string phrase = "Boss! is this you?";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        gets(password);
        ...
        if(strcmp(password, "AD7") == 0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0){
                    ...
                    cout << "I'm a virtual assistant created by my master Ayush !!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master Ayush";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                    ...
                    cout << "Sorry could not understand your query. Please say again !!!" << endl;
                    string phrase = "Sorry could not understand your query. Please say again";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
        ...
        else
                {
                    ...
                    cout << "======================" << endl;
                    cout << "You are not my boss. You know what to do if you are my boss" << endl;
                    cout << "======================" << endl << endl;
                    string phrase = "You are not my boss. You know what to do if you are my boss";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
